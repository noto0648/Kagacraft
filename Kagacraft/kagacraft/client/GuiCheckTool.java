...
public class GuiCheckTool extends GuiScreen
{
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		if(KagacraftRecipes.getDecompserRecipe().containsKey(Arrays.asList(blockID,meta)))
		{
			List<ItemStack> stack = KagacraftRecipes.getDecompserRecipe().get(Arrays.asList(blockID,meta));
			List<Integer> _stack = KagacraftRecipes.getDecompserStacks().get(Arrays.asList(blockID,meta));
