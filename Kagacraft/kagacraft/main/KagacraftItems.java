...
import kagacraft.item.ItemPeriodicTable;
...
public class KagacraftItems
{
	...
	public static void registers()
	{
		...
		periodicTable = new ItemPeriodicTable(KagacraftConfig.periodicTableID - 256);
		...
		GameRegistry.registerItem(periodicTable, "kagacraft.periodictable");
	}
}
