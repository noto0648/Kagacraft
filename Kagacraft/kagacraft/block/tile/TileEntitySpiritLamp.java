...
public class TileEntitySpiritLamp extends TileEntityBase implements IInventory
{
	...
	public void updateEntity()
	{
		...
		if(isWorking())
		{
			...
			{
				if(KagacraftAPI.getLampRecipe().containsKey(Arrays.asList(this.inv[0].itemID, this.inv[0].getItemDamage())))
				{
					ItemStack i = KagacraftAPI.getLampRecipe().get(Arrays.asList(this.inv[0].itemID, this.inv[0].getItemDamage()));
					addSlot(i, 2);
