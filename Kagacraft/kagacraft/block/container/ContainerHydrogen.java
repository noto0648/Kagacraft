...
{
	protected TileEntityHydrogen tileEntity;
	
	public ContainerHydrogen(InventoryPlayer inventoryPlayer, TileEntityHydrogen te)
	{
		this.tileEntity = te;

		this.addSlotToContainer(new Slot(tileEntity, 0, 33, 17));
		this.addSlotToContainer(new Slot(tileEntity, 1, 106, 17));
		this.addSlotToContainer(new Slot(tileEntity, 2, 33, 53));
		this.addSlotToContainer(new Slot(tileEntity, 3, 106, 53));
